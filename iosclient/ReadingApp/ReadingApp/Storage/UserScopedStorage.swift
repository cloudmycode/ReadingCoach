...
extension Notification.Name {
    ...
    static let userDidSwitch = Notification.Name("ReadingCoachUserDidSwitch")
    static let readingAppLogoutRequested = Notification.Name("ReadingAppLogoutRequested")
    static let readingAppAddAccountRequested = Notification.Name("ReadingAppAddAccountRequested")
}
