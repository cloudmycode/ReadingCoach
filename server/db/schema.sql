...
CREATE TABLE `articles` (
  ...
  `read_seconds` int(11) NOT NULL DEFAULT '0' COMMENT '累计有效阅读秒数',
...
CREATE TABLE `user_study_logs` (
  ...
  `read_seconds` int(11) NOT NULL DEFAULT '0' COMMENT '当日有效阅读秒数',
  `review_seconds` int(11) NOT NULL DEFAULT '0' COMMENT '当日有效复习秒数',
